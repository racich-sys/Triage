...
foreach ($name in @("ai_context.md", "PROJECT_ROADMAP_AND_CONTINUATION.md", "CHANGELOG.md", "BUILD_NOTES.md", "VALIDATION_STATUS.md", "README.md", "RUN_GOOGLE_SOURCE_TRIAGE.ps1")) { Copy-IfExists (Join-Path $ProjectRoot $name) "project_docs" }
...
$readme = @(
    "Vestigant Triage v3.4.3 Upload Bundle",
